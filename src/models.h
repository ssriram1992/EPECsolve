...
protected: // Datafields
  ...
  vector<shared_ptr<Game::QP_Param>> country_QP =
      {}; ///< The QP corresponding to each player
  vector<shared_ptr<Game::QP_objective>> LeadObjec =
...
protected: // functions
  ...
  virtual void make_country_QP(const unsigned int i) = 0;
...
class EPEC : public Game::EPEC {
  // Mandatory virtuals
private:
  void make_country_QP(const unsigned int i) override;
